  ...
  return (
    <Card className="w-full">
      <CardHeader>
        ...
        <CardDescription>Upload files for processing. Supported formats: PDF, Excel, CSV.</CardDescription>
      </CardHeader>
      <CardContent>
        <div
        ...
        <Button className="w-full mt-4" onClick={handleUpload} disabled={files.length === 0 || uploading}>
