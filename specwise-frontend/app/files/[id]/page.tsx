...
import { useFileById } from "@/hooks/use-files"
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="text-center py-6 text-muted-foreground">
              <p className="text-red-500">Error loading file details. Please try again.</p>
                ...
                <table className="w-full text-sm">
                  ...
                  <tbody>
                    {file.items.map((item, index) => (
                      <tr key={item.sku} className={index % 2 === 0 ? "bg-white" : "bg-muted/30"}>
